...
function useImportDocument(text: string) {
  ...
  const handleImportDocument = async (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    if (title.trim() === "") {
    ...
    importModal: (
      ...
      >
        <Box sx={style}>
          ...
          <Box component="form" onSubmit={handleImportDocument}>
            <TextField
              value={title}
